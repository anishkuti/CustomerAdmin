    ...
    <div className="flex flex-col h-screen bg-bg-app text-text-main font-sans overflow-hidden">
      ...
      <header className="h-[64px] bg-white border-b border-border-main px-6 flex items-center justify-between flex-shrink-0 z-50">
        <div className="flex items-center gap-8">
           <div className="text-[10px] font-black text-text-muted uppercase tracking-[0.2em] border-r border-border-main pr-8 py-2">
             Workspace
           </div>
        ...
        <aside className="w-[260px] bg-white border-r border-border-main flex flex-col flex-shrink-0">
          ...
          <div className="p-4 border-t border-border-main mt-auto space-y-3">
             <button 
              ...
              className="w-full bg-primary text-white py-3 rounded-xl font-black text-[12px] uppercase tracking-widest flex items-center justify-center gap-2 shadow-lg shadow-primary/20 hover:bg-primary-dark transition-all active:scale-[0.98]"
            >
              <Zap size={14} className="fill-white" /> Quick access
            </button>
            <button 
            ...
            <div className="pt-8">
               ...
               <div className="space-y-3">
                 {offerings.slice(0, 2).map((o) => (
                   <div key={o.id} className="p-4 rounded-2xl border border-border-main bg-white hover:border-primary/40 transition-all cursor-pointer group">
